...
export default class YourInventory extends React.Component<{}, State> {
  ...
  render() {
    ...
    const showServices = () =>
      Object.values(services).map((service, index) => (
        <ServiceCard key={index} service={service} redrawDom={this.getServices} />
      ));
    return (
      <>
        {loading ? (
          ...
          <>
            ...
            <div className="createServiceButton">
              <AppModal title={'Create A New Task'} buttonLabel={'Create A New Task +'}>
                <ServiceForm onUpdate={this.getServices} />
              </AppModal>
            </div>
          </>
        )}
